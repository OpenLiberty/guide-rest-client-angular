...
`app.module.ts`. You must import the HTTP Client module into your module
...
provide a function that will take in the data and store it to the [hotspot=29]`artists` class 
member.
